---
title: Variational Monte Carlo for a custom spin model
permalink: /tutorials/j1j2/
description: Learn how to find the ground-state of a custom spin Hamiltonian, using a Neural-Network quantum state variational ansatz.
---

In this tutorial we will use the NetKet software package to find the ground state of the $$ J_1 J_2 $$ model in one-dimension with periodic boundary condition. The Hamiltonian of the model is given by:
